const config = {
  ...
  shortTitle: 'FM Social media dashboard',
  // Project description. Used in SEO meta tag and by PWA
  description: 'My solution for Frontend Mentor "Social media dashboard with theme switcher" challenge',
  ...
  baseUrl: 'https://p1t1ch-fm-social-media-dashboard.netlify.app',
